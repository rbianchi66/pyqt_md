...
_pkg_config = {
    'pyqt_bin_dir':      '/home/rasky/sip_pyqt/bin/2.6/Linux-64bit',
    'pyqt_config_args':  '--bindir /home/rasky/sip_pyqt/bin/2.6/Linux-64bit --destdir /home/rasky/sip_pyqt/bin/2.6/Linux-64bit --consolidate --confirm-license --verbose --no-docstrings --no-sip-files --concatenate --concatenate-split 6 --enable QtCore --enable QtGui --enable QtOpenGL --enable QtSvg --enable QtWebKit --enable QtNetwork --plugin qjpeg --plugin qsvg',
    'pyqt_mod_dir':      '/home/rasky/sip_pyqt/bin/2.6/Linux-64bit/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtNetwork QtOpenGL QtSvg QtWebKit',
    'pyqt_sip_dir':      '/home/rasky/sip_pyqt/bin/2.6/Linux-64bit/sipbin/PyQt4',
