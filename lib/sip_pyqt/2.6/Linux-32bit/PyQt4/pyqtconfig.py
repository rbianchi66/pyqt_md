...
_pkg_config = {
    'pyqt_bin_dir':      '/home/rasky/sip_pyqt/bin/2.6/Linux-32bit',
    'pyqt_config_args':  '--bindir /home/rasky/sip_pyqt/bin/2.6/Linux-32bit --destdir /home/rasky/sip_pyqt/bin/2.6/Linux-32bit --consolidate --confirm-license --verbose --no-docstrings --no-sip-files --concatenate --concatenate-split 6 --enable QtCore --enable QtGui --enable QtOpenGL --enable QtSvg --enable QtWebKit --enable QtNetwork --plugin qjpeg --plugin qsvg',
    'pyqt_mod_dir':      '/home/rasky/sip_pyqt/bin/2.6/Linux-32bit/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtNetwork QtOpenGL QtSvg QtWebKit',
    'pyqt_sip_dir':      '/home/rasky/sip_pyqt/bin/2.6/Linux-32bit/sipbin/PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_X11 -x PyQt_Accessibility -x PyQt_SessionManager -x PyQt_NoPrintRangeBug -t Qt_4_6_2 -x Py_v3 -g',
