...
_pkg_config = {
    'arch':             '',
    'default_bin_dir':  '/Library/Frameworks/Python.framework/Versions/2.6/bin',
    'default_mod_dir':  '/Library/Frameworks/Python.framework/Versions/2.6/lib/python2.6/site-packages',
    'default_sip_dir':  '/Users/Guest/src/qt46/bin/2.6/Darwin-32bit/sipbin',
    'platform':         'macx-g++',
    'py_conf_inc_dir':  '/Library/Frameworks/Python.framework/Versions/2.6/include/python2.6',
    'py_inc_dir':       '/Library/Frameworks/Python.framework/Versions/2.6/include/python2.6',
    'py_lib_dir':       '/Library/Frameworks/Python.framework/Versions/2.6/lib/python2.6/config',
    'py_version':       0x020605,
    'sip_bin':          '/Users/Guest/src/qt46/bin/2.6/Darwin-32bit/sipbin/sip',
    'sip_config_args':  '-b /Users/Guest/src/qt46/bin/2.6/Darwin-32bit/sipbin -d /Users/Guest/src/qt46/bin/2.6/Darwin-32bit -v /Users/Guest/src/qt46/bin/2.6/Darwin-32bit/sipbin -e /Users/Guest/src/qt46/bin/2.6/Darwin-32bit/sipbin LFLAGS_PLUGIN="-arch ppc -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk -g -bundle -undefined dynamic_lookup"',
    'sip_inc_dir':      '/Users/Guest/src/qt46/bin/2.6/Darwin-32bit/sipbin',
    'sip_mod_dir':      '/Users/Guest/src/qt46/bin/2.6/Darwin-32bit',
...
_default_macros = {
    ...
    'LFLAGS_DLL':               '',
    'LFLAGS_OPENGL':            '',
    'LFLAGS_PLUGIN':            '"-arch ppc -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk -g -bundle -undefined dynamic_lookup"',
    'LFLAGS_RELEASE':           '',
...
class Makefile:
    ...
    def finalise(self):
        ...
        if self._qt or self._opengl:
            if self.config.qt_version < 0x040000 or (self._qt and "QtGui" in self._qt):
