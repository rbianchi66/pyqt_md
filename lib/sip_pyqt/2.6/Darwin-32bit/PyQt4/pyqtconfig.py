...
_pkg_config = {
    'pyqt_bin_dir':      '/Users/Guest/src/qt46/bin/2.6/Darwin-32bit',
    'pyqt_config_args':  '--bindir /Users/Guest/src/qt46/bin/2.6/Darwin-32bit --destdir /Users/Guest/src/qt46/bin/2.6/Darwin-32bit --consolidate --confirm-license --verbose --no-docstrings --no-sip-files --concatenate --concatenate-split 6 --enable QtCore --enable QtGui --enable QtOpenGL --enable QtSvg --enable QtWebKit --enable QtNetwork --plugin qjpeg --plugin qsvg',
    'pyqt_mod_dir':      '/Users/Guest/src/qt46/bin/2.6/Darwin-32bit/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtNetwork QtOpenGL QtSvg QtWebKit',
    'pyqt_sip_dir':      '/Users/Guest/src/qt46/bin/2.6/Darwin-32bit/sipbin/PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_MACX -x PyQt_Accessibility -x PyQt_OpenSSL -x PyQt_NoPrintRangeBug -t Qt_4_6_2 -x Py_v3 -g',
