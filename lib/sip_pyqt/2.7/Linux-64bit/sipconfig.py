...
_pkg_config = {
    ...
    'default_sip_dir':  '/root/Qt-4.6.2-x86_64/sip_pyqt/bin/2.7/Linux-64bit/sipbin',
    'platform':         'linux-g++',
    'py_conf_inc_dir':  '/usr/include/python2.7',
    'py_inc_dir':       '/usr/include/python2.7',
    'py_lib_dir':       '/usr/lib/python2.7/config',
    'py_version':       0x020703,
    'sip_bin':          '/root/Qt-4.6.2-x86_64/sip_pyqt/bin/2.7/Linux-64bit/sipbin/sip',
    'sip_config_args':  '-b /root/Qt-4.6.2-x86_64/sip_pyqt/bin/2.7/Linux-64bit/sipbin -d /root/Qt-4.6.2-x86_64/sip_pyqt/bin/2.7/Linux-64bit -v /root/Qt-4.6.2-x86_64/sip_pyqt/bin/2.7/Linux-64bit/sipbin -e /root/Qt-4.6.2-x86_64/sip_pyqt/bin/2.7/Linux-64bit/sipbin',
    'sip_inc_dir':      '/root/Qt-4.6.2-x86_64/sip_pyqt/bin/2.7/Linux-64bit/sipbin',
    'sip_mod_dir':      '/root/Qt-4.6.2-x86_64/sip_pyqt/bin/2.7/Linux-64bit',
