...
_pkg_config = {
    'pyqt_bin_dir':      '/root/Qt-4.6.2-i386/sip_pyqt/bin/2.7/Linux-32bit',
    'pyqt_config_args':  '--bindir /root/Qt-4.6.2-i386/sip_pyqt/bin/2.7/Linux-32bit --destdir /root/Qt-4.6.2-i386/sip_pyqt/bin/2.7/Linux-32bit --consolidate --confirm-license --verbose --no-docstrings --no-sip-files --concatenate --concatenate-split 6 --enable QtCore --enable QtGui --enable QtOpenGL --enable QtSvg --enable QtWebKit --enable QtNetwork --plugin qjpeg --plugin qsvg',
    'pyqt_mod_dir':      '/root/Qt-4.6.2-i386/sip_pyqt/bin/2.7/Linux-32bit/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtNetwork QtOpenGL QtSvg QtWebKit',
    'pyqt_sip_dir':      '/root/Qt-4.6.2-i386/sip_pyqt/bin/2.7/Linux-32bit/sipbin/PyQt4',
